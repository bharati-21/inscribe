...
import { deleteFromTrashHandler, getAllTrashedNotesHandler, restoreFromTrashHandler } from "backend/controllers/TrashController";
...
export function makeServer({ environment = "development" } = {}) {
  const server = new Server({
    ...
    routes() {
      ...
      this.get('/api/trash', getAllTrashedNotesHandler.bind(this)); 
      this.post('/api/trash/restore/:noteId', restoreFromTrashHandler.bind(this));
      this.delete('/api/trash/delete/:noteId', deleteFromTrashHandler.bind(this));
    },
  });
  return server;
}
